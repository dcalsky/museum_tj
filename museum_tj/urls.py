...
urlpatterns = [
    ...
    url(r'^museum/admin/', admin.site.urls),
    url(r'^museum/part/(?P<part_name>\w+)/', include('vector.urls'), name='part'),
    url(r'^museum/search$', view_search.search, name='search'),
    url(r'^museum/appoint$', view_appoint.apply_appoint, name='appoint'),
